    ...
    { !props.check?<div><h4>No Data Found</h4></div>: (!actor&&!show?<div><p>Loading...</p></div>:actor?<div className="data">
      {actor.map((item)=>{
        return <div className="content">
          <div className="img">
        <img src={item.person.image!==null?item.person.image.original:"https://static.tvmaze.com/images/no-img/no-img-portrait-text.png" } alt=" "/></div>
      ...
      {show.map((item)=>{
        return <div className="host">
          <div className="pic">
            <img src={item.show.image!==null?item.show.image.original:"https://static.tvmaze.com/images/no-img/no-img-portrait-text.png" } alt=" "/>
          </div>
          <div className="name">
